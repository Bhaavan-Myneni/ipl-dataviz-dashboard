...
history_df = pd.read_csv("https://drive.google.com/uc?export=download&id=1U7vH-e00KnhMx7orXSQoa4SQkC-6-APz")
...
with tab3:
    ...
    # Load and preprocess
    ipl_data = pd.read_csv("https://drive.google.com/uc?export=download&id=1U7vH-e00KnhMx7orXSQoa4SQkC-6-APz")
    matches_df = pd.read_csv("Updated_Matches.csv")
